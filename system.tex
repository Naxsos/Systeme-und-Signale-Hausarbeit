...
\begin{align*} 
    y_{stat} = |\mathcal{G}(j\omega_0)| \cdot A \cdot sin(\omega_0 t+\phi_0 + arg \enspace \mathcal{G}(j\omega_0))
\end{align*}
...
Für den Betrag eines Bruches gilt: $BetragBruch = BetragZ\ddot ahler / BetragNenner$ \\
...
$arg(\frac{a + bj}{c + dj}) = WinkelZ\ddot ahler - WinkelNenner = arctan\frac{b}{a} - arctan\frac{d}{c}$ \\
